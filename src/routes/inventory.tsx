...
export function InventoryManagement({ initialView }: { initialView: View }) {
  ...
  const [sortKey, setSortKey] = useState<"name" | "category" | "quantity" | "batches" | "price">("name");
...
function InventoryTable({ items, totalItems, query, setQuery, categoryFilter, setCategoryFilter, stockFilter, setStockFilter, sortKey, setSortKey, sortDirection, setSortDirection, page, pageSize, setPage, setPageSize, loading }: { items: InventoryItem[]; totalItems: number; query: string; setQuery: (value: string) => void; categoryFilter: "all" | InventoryItem["category"]; setCategoryFilter: (value: "all" | InventoryItem["category"]) => void; stockFilter: "all" | "available" | "empty"; setStockFilter: (value: "all" | "available" | "empty") => void; sortKey: "name" | "category" | "quantity" | "batches" | "price"; setSortKey: (value: "name" | "category" | "quantity" | "batches" | "price") => void; sortDirection: "asc" | "desc"; setSortDirection: (value: "asc" | "desc") => void; page: number; pageSize: number; setPage: (value: number) => void; setPageSize: (value: number) => void; loading: boolean }) {
